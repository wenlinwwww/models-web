...
<template>
  <div class=" bg-gray-100 dark:bg-[#282832] h-[55px] flex  justify-around  items-center dark:text-white/70 ">
    ...
    <!-- 移动端加了一个百度文库的跳转链接，感觉移动端其实不需要这个来着 -->
    <!-- <a v-if="!isDisableMenu('ppt')" href="https://wenku.baidu.com" target="_blank" class="flex items-center justify-center flex-col">
        <SvgIcon icon="material-symbols:edit-document-outline" class="text-3xl"></SvgIcon>
        <div class="text-[13px]">{{$t('mjtab.ppt')}}</div>
      </a>  -->
  </div>
