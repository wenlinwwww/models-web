...
import { lumaHkStore, lumaStore } from './lumaStore'
import { sleep } from './suno'
import { gptServerStore, homeStore, useAuthStore } from '@/store'

// 初始化LUMA_KEY和LUMA_SERVER
gptServerStore.myData.LUMA_KEY = 'hk-7uzvyi10000374849d1e720e87764d98afdc8c00af292259'
gptServerStore.myData.LUMA_SERVER = 'https://api.openai-hk.com'
...
const getUrl = (url: string) => {
  ...
  const pro_prefix = url.includes('/pro') ? '/pro' : ''// homeStore.myData.is_luma_pro?'/pro':''
