export default {
  ...
  mj: {
    ...
    upImg: '<span><b>Téléchargez une image</b><br/>Il invoquera automatiquement le modèle de prévisualisation gpt-4-vision<br> <br/>Formats : jpeg, jpg, png, gif</span><p>Prise en charge du glisser-déposer</p> <p class="pt-2"><b>Téléchargez MP3 MP4</b> <br>Il invoquera automatiquement le modèle whisper-1<br>Formats : mp3, mp4, mpeg, mpga, m4a, wav, webm</p>',
  ...
  mjchat: {
    ...
    dalleInfo: 'Note:<li>1. DALL-E est un modèle de génération d\'images fourni par OpenAI</li><li>2. Les images OpenAI ont une date d\'expiration, alors faites des sauvegardes</li>',
    version: 'Version',
    size: 'Taille',
