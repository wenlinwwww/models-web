export default {
  ...
  mj: {
    ...
    upImg: '<span><b>上传图片</b><br/>会自动调用 gpt-4-vision-preview 模型<br> <br/>格式: jpeg jpg png gif</span><p>支持拖拽</p> <p class="pt-2"><b>上传MP3 MP4</b> <br>会自动直接调用 whisper-1 模型<br>格式有：mp3 mp4 mpeg mpga m4a wav webm</p>',
    clearAll: '清参数',
    czoom: '自定义',
    customTitle: '自定义变焦',
