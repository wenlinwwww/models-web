export default {
  ...
  mj: {
    ...
    upImg: '<span><b>이미지 업로드</b><br/>자동으로 gpt-4-vision-preview 모델을 호출합니다<br> <br/>포맷: jpeg, jpg, png, gif</span><p>드래그 앤 드롭 지원</p> <p class="pt-2"><b>MP3 MP4 업로드</b> <br>자동으로 whisper-1 모델을 호출합니다<br>포맷: mp3, mp4, mpeg, mpga, m4a, wav, webm</p>',
    clearAll: '매개변수 지우기',
    czoom: '사용자 정의',
  ...
  mjchat: {
    ...
    tStyles: '아트 정도',
    tVersion: '모델 버전',
    dalleInfo: '설명：<li>1. DALL-E는 OpenAI에서 제공하는 그림 모델입니다.</li>  <li>2. OpenAI의 이미지는 일시적입니다. 백업을 잘 해 두세요.</li>  ',
    version: '버전',
    size: '크기',
